...
import com.rosi.memodiary.R;
import com.rosi.memodiary.adapter.DataAdapter;
import com.rosi.memodiary.helper.RealmHelper;
import com.rosi.memodiary.model.ModelSiswa;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(ProdukActivity.this, TambahDataActivity.class));
        ...
        helper = new RealmHelper(ProdukActivity.this);
        recycler.setAdapter(new DataAdapter(ProdukActivity.this, dataSiswa));
        recycler.setLayoutManager(new LinearLayoutManager(ProdukActivity.this));
